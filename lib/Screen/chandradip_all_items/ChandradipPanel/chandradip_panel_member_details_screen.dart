...
class ChandradipPanelMemberDetailsScreen extends StatelessWidget {
  PadmaPanelMemberModel padmaPanelMemberModel;

  ChandradipPanelMemberDetailsScreen({Key? key, required this.padmaPanelMemberModel})
      : super(key: key);
                ...
                child: Center(
                  child: ClipOval(
                    child: CachedNetworkImage(
                      imageUrl: padmaPanelMemberModel.imageUrl!,
                  ...
                  children: [
                    InkWell(
                      onTap: () async {
                        final Uri url = Uri(
                          scheme: "tel",
                          path: "${padmaPanelMemberModel.memberNumber}",
                        );
                        launchUrl(url);
                      },
